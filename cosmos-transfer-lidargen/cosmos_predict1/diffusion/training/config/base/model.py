...
@attrs.define(slots=False)
class LidarModelConfig(DefaultModelConfig):
    n_views: int = 4
    rgb_latent_shape: List[int] = [88, 160]
    lidar_latent_shape: List[int] = [64, 224]
    rgb_shape: List[int] = [704, 1280]
    lidar_shape: List[int] = [512, 1792]