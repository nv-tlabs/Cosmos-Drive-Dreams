...
def get_cosmos_diffusion_lidar_tokenizer(resolution: str, chunk_duration: int) -> omegaconf.dictconfig.DictConfig:
    ...
    return L(JointImageLidarTokenizer)(
        ...
        image_vae=L(JITVAE)(
            name="CV8x8x8",
            mean_std_fp="checkpoints/edify_video_tokenizer_res720_comp8x8x8_t121_ver092624_image/mean_std.pt",
            enc_fp="checkpoints/edify_video_tokenizer_res720_comp8x8x8_t121_ver092624_image/encoder.jit",
            dec_fp="checkpoints/edify_video_tokenizer_res720_comp8x8x8_t121_ver092624_image/decoder.jit",
            latent_ch=16,
            is_image=False,
            is_bf16=True,
        ),
        lidar_vae=L(JITVAE)(
            ...
            mean_std_fp="checkpoints/Cosmos-Tokenizer-Lidar8x8/mean_std.pt",
            enc_fp="checkpoints/Cosmos-Tokenizer-Lidar8x8/encoder.jit",
            dec_fp="checkpoints/Cosmos-Tokenizer-Lidar8x8/decoder.jit",
            is_image=True,
            is_bf16=False,
            latent_ch=16,
        ),
