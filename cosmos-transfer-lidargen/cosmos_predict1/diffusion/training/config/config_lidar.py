...
from cosmos_predict1.diffusion.training.config.base.model import LidarModelConfig

from cosmos_predict1.diffusion.training.config.text2world.registry import (
    register_configs as register_configs_text2world,
)

from cosmos_predict1.diffusion.training.config.text2world_imagetolidar.registry import (
    register_configs as register_configs_imagetolidar,
)
...
def make_config():
    ...
    register_configs_imagetolidar()
    import_all_modules_from_package("cosmos_predict1.diffusion.training.config.text2world", reload=True)
    import_all_modules_from_package("cosmos_predict1.diffusion.training.config.text2world_imagetolidar", reload=True)
    return c
