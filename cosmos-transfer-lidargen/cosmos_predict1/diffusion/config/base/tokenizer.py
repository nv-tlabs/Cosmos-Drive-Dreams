...
from cosmos_predict1.diffusion.module.pretrained_vae import JITVAE, JointImageVideoSharedJITTokenizer, VideoJITTokenizer, BasePretrainedImageVAE
from cosmos_predict1.diffusion.training.module.pretrained_vae import JointImageLidarTokenizer
...
def get_cosmos_diffusion_lidar_tokenizer(resolution: str, chunk_duration: int) -> omegaconf.dictconfig.DictConfig:
    ...
    return L(JointImageLidarTokenizer)(
        ...
        latent_ch=16,
        image_vae=L(BasePretrainedImageVAE)(
            name="CV8x8x8",
            latent_ch=16,
            is_image=False,
            is_bf16=True,
        ),
        lidar_vae=L(BasePretrainedImageVAE)(
