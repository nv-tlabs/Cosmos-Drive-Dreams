...
class DataField(Enum):
    ...
    # [B, 4, 4], float32, camera-to-lidar transformation matrix.
    CAMERA_C2LIDAR_TRANSFORM = "camera_c2lidar_transform"
    # [B, 4], float32, OpenCV pinhole intrinsics represented as [fx, fy, cx, cy].
    CAMERA_INTRINSICS = "camera_intrinsics"
    # [B, H, W, 3], float32, hdmap image.
    IMAGE_HDMAP = "image_hdmap"
